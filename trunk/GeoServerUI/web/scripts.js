            ...
            for (var i=0; i < geofenceLine.length-1; i++){
               ...
               var aGeofence = geofenceLine[i].split("%%");
                ...
                if ( allCoords.length > 1 ){
                    ...
                    //we save the first point for later usage
                    var premierCoord = allCoords[0].split(";");
                    ...
                    //we add the first point at the end for closing the polygon
                    point = new GLatLng(premierCoord[0],premierCoord[1]);
                    tabZone.push(point);
