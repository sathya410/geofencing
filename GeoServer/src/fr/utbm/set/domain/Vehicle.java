...
public class Vehicle {
    ...
    private TMLVehicleType typeVehicle;

    public Vehicle(){};

    public Vehicle(double height, double weight, boolean isTDG, int speedLimit, TMLVehicleType typeVehicle){
        this.height = height;
        this.weight = weight;
        this.isTDG = isTDG;
     ...
     */
    public TMLVehicleType getTypeVehicle() {
        return typeVehicle;
    }
     ...
     */
    public void setTypeVehicle(TMLVehicleType typeVehicle) {
        this.typeVehicle = typeVehicle;
    }
